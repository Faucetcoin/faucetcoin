...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Faucetcoin " + FormatFullVersion();
...
{"faucetcoin.org", "dnsseed.faucetcoin.org"},
{"faucetcoin.net", "dnsseed.faucetcoin.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
{"faucetcoin.org", "testnet-seed.faucetcoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Faucetcoin is probably already running."), addrBind.ToString().c_str());
        else
